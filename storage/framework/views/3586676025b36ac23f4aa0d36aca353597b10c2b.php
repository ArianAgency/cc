<button class="navbar-toggler mobile-sidebar-toggler d-lg-none ml-auto" type="button">
...
<ul class="nav navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <img src="admin/content/img/avatars/6.jpg" class="img-avatar" alt="<?php echo e(Auth::guard('customers')->user()->name); ?>">
        </a>
        <div class="dropdown-menu dropdown-menu-left">
            ...
            <a class="dropdown-item" href="<?php echo e(route('customer-logout')); ?>"><i class="fa fa-lock"></i> خروج</a>
        </div>
    </li>
</ul>
...
<?php /**PATH C:\Club\cc\resources\views/customer/main/app-header.blade.php ENDPATH**/ ?>