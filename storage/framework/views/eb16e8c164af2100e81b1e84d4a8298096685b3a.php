<nav class="sidebar-nav">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('panel')); ?>"><i class="icon-speedometer"></i> پیشخوان <span
                    class="badge badge-primary">جدید</span></a>
        </li>

        <li class="nav-divider"></li>

        <?php if(checkRolesAccessLevel(  Auth::user()->role_id ,2)): ?>
        ...
        <?php endif; ?>
        <?php if(checkRolesAccessLevel(  Auth::user()->role_id ,6)): ?>
            <li class="nav-item nav-dropdown">
...
<?php /**PATH C:\Club\cc\resources\views/admin/main/app-body-sidebar.blade.php ENDPATH**/ ?>