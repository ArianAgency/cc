            ...
            <div class="row">
                        ...
                        <div class="card-body pb-0">
                            <div class="btn-group float-left">
                                ...
                                <div class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <a class="dropdown-item" href="#">عملیات</a>
                                    <a class="dropdown-item" href="#">لرم اپیسوم</a>
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card text-white bg-info">
                        <div class="card-body pb-0">
                            <button type="button" class="btn btn-transparent p-0 float-left">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="callout callout-info">
                                                <small class="text-muted">مشتریان جدید</small>
                                                <br>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="callout callout-danger">
                                                <small class="text-muted">مشتریان قدیم</small>
                                                <br>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="callout callout-warning">
                                                <small class="text-muted">بازدید صفحات</small>
                                                <br>
                                    ...
                                    <ul class="icons-list">
                                        <li>
                                            ...
                                            <div class="desc">
                                                ...
                                                <small>لرم اپیزوم اسپوت لرم اپیزوم اسپوت </small>
                                            </div>
                                            <div class="value">
                                                <div class="small text-muted">فروش در هفته</div>
                                                <strong>1.924</strong>
                                            </div>
                                            <div class="actions">
                                        ...
                                        <li>
                                            ...
                                            <div class="desc">
                                                <div class="title">کتاب الکترونیکی</div>
                                                <small>لرم اپیزوم اسپوت لرم اپیزوم اسپوت </small>
                                            </div>
                                            <div class="value">
                                                <div class="small text-muted">دانلودها</div>
                                        ...
                                        <li>
                                            ...
                                            <div class="value">
                                                <div class="small text-muted">بارگذاری ها</div>
                            ...
                            <table class="table table-responsive-sm table-hover table-outline mb-0">
                                ...
                                <tr>
                                    ...
                                    <th>مصرف</th>
                                    <th class="text-center">روش پرداهت</th>
                                    <th>فعالیت</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img src="admin/content/img/avatars/1.jpg" class="img-avatar"
                                                 alt="*****************">
                                    ...
                                    <td>
                                        <div>علی احمدی</div>
                                        <div class="small text-muted">
                                            <span>جدید</span> | ثبت نام : فروردین 1395
                                        </div>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <small class="text-muted">اردیبهشت 97</small>
                                            </div>
                                        </div>
                                        <div class="progress progress-xs">
                                    ...
                                    <td>
                                        <div class="small text-muted">آخرین بازدید</div>
                                        <strong>10 ثانیه فبل</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-muted">
                                            ...
                                            <span>بازگشت</span> | ثبت نام: فروردین 97
                                        </div>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>محمد حسینی</div>
                                        <div class="small text-muted">
                                            <span>جدید</span> | ثبت نام: فروردین 96
                                        </div>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>حسین محمدی</div>
                                        <div class="small text-muted">
                                            <span>جدید</span> | ثبت نام: فروردین 1396
                                        </div>
                                    </td>
                                    <td class="text-center">
...
<?php echo $__env->make('admin.master-admin-template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Club\cc\resources\views/admin/main/home.blade.php ENDPATH**/ ?>