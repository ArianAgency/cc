    ...
    export default {
        ...
        data() {
            return {
                ...
                formItems: {
                    category_name: '',
                    description: '',
                    id_services_category_name: 0
                },
                company_name: '-',
                newPostURL: '/admin-panel/service/action/createNewCategory',
                editPostURL: '/admin-panel/service/action/editCategory',
        ...
        methods: {
            async submitForm_customerCategoryForm(event) {
                ...
                if (this.formItems.id_services_category_name !== 0) {
                    Object.assign(data, {'id_category': this.formItems.id_services_category_name})
                }
        ...
        created: function () {
            console.log('serviceCategoryForm created ')

        }
        ,
        mounted: function () {
            console.log('serviceCategoryForm mounted ')
            ...
            this.$root.$on('EditCategory', (toEdit) => {
                ...
                this.formItems.id_services_category_name = toEdit.id_services_category_name;
