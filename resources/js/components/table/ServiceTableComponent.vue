                ...
                <div class="card-body">
                    <table class="table table-responsive-sm table-striped mytable">
                        ...
                        <tr v-for="(service,index) in $parent.data.data.data">
                            ...
                            <th v-on:click="$parent.indexForEdit = index ,$parent.activeView = 'add',$parent.pageTitle = 'ویرایش اطلاعات سرویس'">
                                <a href="#">
                                    <i class="fa fa-edit"/>
                                </a>
                            </th>
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item" v-show="data.data.next_page_url !==null"><a class="page-link" href="#"
                                 v-on:click="$parent.getServiceData(data.data.next_page_url)">{{data.data.current_page     + 1}}</a>
                        </li>
