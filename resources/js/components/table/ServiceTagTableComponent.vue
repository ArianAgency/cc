                ...
                <div class="card-body">
                    <table class="table table-responsive-sm table-striped mytable">
                        ...
                        <tr v-for="(categoryList,index) in categoryList">
                            ...
                            <td>{{categoryList.tag_name}}</td>
                            <td>{{categoryList.id_business}}</td>

                            <td v-bind:id="'sw_lb_'+ categoryList.id_services_tag_name">
                            ...
                            <td><label class="switch switch-text switch-pill switch-info-outline-alt">
                                <input type="checkbox" class="switch-input" v-bind:checked="categoryList.is_active"
                                       v-bind:id="'sw_' + categoryList.id_services_tag_name"
                                       v-on:click="check($event,categoryList.id_services_tag_name)">
    ...
    export default {
        ...
        methods: {
            check(event, id_category) {
                ...
                // console.log('id_services_category_name : ' + id_services_category_name);

                axios.post('/admin-panel/service/action/tagActivationStatus', {
                    id_tag: id_category,
                    value: status
                })
        ...
        created: function () {
            console.log('ServiceTagTableComponent created.')

        },
        mounted: function () {
            console.log('ServiceTagTableComponent mounted.')
            this.getCategories('/admin-panel/service/get/tags');
